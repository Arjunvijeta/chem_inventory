...
const Login = () => {
  ...
  return (
    <section
      className="bg-slate-400 dark:bg-gray-900 bg-cover bg-center"
      style={{ backgroundImage: `url(${background})` }}
    >
      {/* <div className="fixed top-0 right-0 h-[20vw] w-[20vw] rounded-full opacity-30 blur-3xl  bg-black -z-1"></div> */}
      <div className="flex flex-col items-end justify-center px-6 py-8 max-w-sm  mx-auto md:h-screen lg:py-0">
